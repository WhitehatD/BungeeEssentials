...
public class WalkspeedCommand extends Command {
    ...
    public WalkspeedCommand(Core core){
        super("speed");
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if(args.length != 1){
            core.getChatUtil().cmessage(player, "messages.walkspeed.usage");
            return;
        }
        ...
        core.getChatUtil().cmessage(player, "messages.walkspeed.success", s -> s.replaceAll("%number%", number + ""));
    }
}
